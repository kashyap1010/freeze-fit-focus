...
date: "2023-05-30"
author: "Dr. Katherine Wilson"
authorTitle: "Physical Therapist, DPT, OCS"
featuredImage: "/placeholder.svg"
category: "Exercise"
tags: ["low impact", "joint health", "mobility", "senior fitness"]
---
...
### 4. Progressive Overload Without Joint Stress

<CodeBlock language="markdown">
# Joint-Friendly Progression Methods

| Method | Example | Benefit |
|--------|---------|---------|
| Increase time under tension | 2-second to 4-second lowering phase | Reduced peak forces |
| Add isometric holds | Mid-range pauses during movements | Joint stability |
| Increase volume before load | 8 reps to 12 reps before adding weight | Tissue adaptation |
| Adjust leverage | Wall push-up to incline push-up | Gradual loading |
| Use variable resistance | Resistance bands with chains or cables | Matched strength curve |
</CodeBlock>
